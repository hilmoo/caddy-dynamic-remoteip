...
func (m MatchDynamicRemoteIP) MatchWithError(r *http.Request) (bool, error) {
	address := r.RemoteAddr
	remoteIP, err := parseIPFromString(address)
...
var (
	...
	_ caddyhttp.RequestMatcherWithError = (*MatchDynamicRemoteIP)(nil)
)
